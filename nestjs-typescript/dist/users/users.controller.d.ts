...
export declare class UsersController {
    ...
    create(createUserDto: CreateUserDto): Promise<"Tên người dùng đã được sử dụng" | "Emai đã được sử dụng" | "Tạo tài khoản thành công" | undefined>;
    findAll(): Promise<import("./entities/user.entity").Users[]>;
    findOne(id: string): Promise<import("./entities/user.entity").Users | null> | null;
